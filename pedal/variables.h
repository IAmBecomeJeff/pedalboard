...
fire_palette = HeatColors_p;
fire_palette2 = CRGBPalette16(CRGB::Black, CRGB::Red, CRGB::Yellow, CRGB::White);
fire_palette_blue = CRGBPalette16(CRGB::Black, CRGB::Blue, CRGB::Aqua, CRGB::White);
#define COOLING 55
#define SPARKING 120
